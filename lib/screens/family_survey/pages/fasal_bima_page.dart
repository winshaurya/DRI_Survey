...
class FasalBimaPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<FasalBimaPage> createState() => _FasalBimaPageState();
}

class _FasalBimaPageState extends ConsumerState<FasalBimaPage> {
  ...
  @override
  void didUpdateWidget(covariant FasalBimaPage oldWidget) {
  ...
  Widget build(BuildContext context) {
    return FormTemplateScreen(
        title: 'Fasal Bima Beneficiary',
        stepNumber: '31',
        nextScreenRoute: '/animals', // assuming next screen
        nextScreenName: 'Animals', // assuming next screen
        icon: Icons.shield,
        onReset: () {
            setState(() {
               _schemeData = {'is_beneficiary': false, 'members': []};
